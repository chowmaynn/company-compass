    ...
    <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
      {cards.map((card) => (
        <div
          ...
          className={`rounded-xl p-5 transition-all bg-gradient-to-b from-black/[0.04] to-black/[0.02] dark:from-white/[0.06] dark:to-white/[0.02] backdrop-blur-xl ring-1 ring-black/15 dark:ring-white/10 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08),0_2px_12px_-4px_rgba(0,0,0,0.2)] ${card.border} ${onCardClick ? "cursor-pointer" : ""}`}
        >
