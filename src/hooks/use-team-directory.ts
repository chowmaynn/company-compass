...
async function fetchDirectory(): Promise<TeamMember[]> {
  // Use the standard directory endpoint — returns location dropdown (country-level)
  // for all employees in a single GET. Name overrides handle specific people whose
  // location is "Remote" or blank.
