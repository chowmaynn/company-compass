            ...
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6">
              ...
              <div className="space-y-2 max-h-[260px] overflow-y-auto pr-1">
                {circlePosts.map((p) => {
                  ...
                  return (
                    <div key={p.id} className={`rounded-lg border p-3 ${colours.border} ${isPending ? "bg-amber-50/40" : "bg-white"}`}>
                  ...
                  <button
                    ...
                    className={`w-full rounded-lg border p-2 text-left transition-all ${
                      !cell.isCurrentMonth
                        ...
                        : calls.length > 0
                        ? "border-border/60 bg-white hover:bg-muted/40 cursor-pointer"
                        : "border-border/30 bg-white/50 hover:bg-muted/20 cursor-pointer"
                    }`}
                  >
          ...
          {expandedDay && dayMap[expandedDay] && (
            <div className="mt-4 rounded-xl border border-border/60 overflow-hidden">
              ...
              <div className="divide-y divide-border/50">
                {/* Table header */}
                <div className="grid grid-cols-[80px_1fr_140px_1fr_60px_100px] gap-3 px-4 py-2 text-[10px] font-semibold text-muted-foreground uppercase tracking-wider bg-white">
                  <span>Time</span>
                  <span>Member</span>
                  <span>Coach</span>
                  <span>Call Type</span>
                ...
                {dayMap[expandedDay].map((r) => {
                  ...
                  return (
                    <div
                      key={r.id}
                      className="grid grid-cols-[80px_1fr_140px_1fr_60px_100px] gap-3 items-center px-4 py-2.5 hover:bg-muted/20 transition-colors bg-white"
                    >
